...
// node_modules/@nutui/icons-vue/dist/es/icons/IconFontConfig.js
var a = "nutui-icon";
var e = [
  {
    name: "粗体 Icon",
...
var N = defineComponent({
  ...
  setup(n2, { emit: i2 }) {
    var a2;
    const t = n2, c = "nut-icon", l = (e2) => {
      i2("click", e2);
    }, o = useSlots();
    useAttrs();
    const u = () => t.name ? t.name.indexOf("/") !== -1 : false, r = (e2) => {
      if (e2)
        return isNaN(Number(e2)) ? String(e2) : e2 + "px";
    }, s = u();
    let m = h(
      s ? "img" : t.tag,
      {
    ...
    const f2 = () => m;
    return (e2, x2) => (openBlock(), createBlock(f2));
  }
});
...
var b = defineComponent({
  ...
  setup(c, { emit: r }) {
    const t = c, l = (e2) => {
      ...
      const e2 = {};
      return e2.height = s(t.height), e2.width = s(t.width), e2.color = t.color, e2;
    });
    return (e2, _80) => (openBlock(), createElementBlock("svg", {
...
var C = defineComponent({
  ...
  setup(c, { emit: o }) {
    const t = c, r = (e2) => {
      ...
      const e2 = {};
      return e2.height = l(t.height), e2.width = l(t.width), e2.color = t.color, e2;
    });
    return (e2, _80) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
...
var b2 = defineComponent({
  ...
  setup(n2, { emit: s }) {
    const t = n2, c = (e2) => {
      ...
      const e2 = {};
      return e2.height = o(t.height), e2.width = o(t.width), e2.color = t.color, e2;
    });
    return (e2, _80) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
...
var b4 = defineComponent({
  ...
  setup(n2, { emit: s }) {
    const t = n2, c = (e2) => {
      ...
      const e2 = {};
      return e2.height = r(t.height), e2.width = r(t.width), e2.color = t.color, e2;
    });
    return (e2, w27) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
      onClick: c,
      xmlns: "http://www.w3.org/2000/svg",
...
var C2 = defineComponent({
  ...
  setup(s, { emit: r }) {
    const t = s, l = (e2) => {
      ...
      const e2 = {};
      return e2.height = n2(t.height), e2.width = n2(t.width), e2.color = t.color, e2;
    });
    return (e2, _80) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
...
var w3 = defineComponent({
  ...
  setup(c, { emit: r }) {
    ...
    return (e2, C38) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
      onClick: o,
      xmlns: "http://www.w3.org/2000/svg",
...
var S5 = defineComponent({
  ...
  setup(c, { emit: l }) {
    ...
    return (e2, z11) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
      onClick: s,
      xmlns: "http://www.w3.org/2000/svg",
...
var w5 = defineComponent({
  ...
  setup(n2, { emit: s }) {
    ...
    return (e2, S56) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
      onClick: c,
      xmlns: "http://www.w3.org/2000/svg",
...
var S8 = defineComponent({
  ...
  setup(l, { emit: r }) {
    const t = l, s = (e2) => {
      ...
      const e2 = {};
      return e2.height = c(t.height), e2.width = c(t.width), e2.color = t.color, e2;
    });
    return (e2, C38) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
...
var b12 = defineComponent({
  ...
  setup(l, { emit: s }) {
    ...
    return (e2, x2) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
...
var S21 = defineComponent({
  ...
  setup(n2, { emit: s }) {
    ...
    return (e2, b58) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
      onClick: c,
      xmlns: "http://www.w3.org/2000/svg",
...
var S37 = defineComponent({
  ...
  setup(c, { emit: i2 }) {
    const e2 = c, a2 = (t) => {
      ...
      const t = {};
      return t.height = o(e2.height), t.width = o(e2.width), t.color = e2.color, t;
    });
...
var S38 = defineComponent({
  ...
  setup(o, { emit: i2 }) {
    const e2 = o, a2 = (t) => {
      ...
      const t = {};
      return t.height = c(e2.height), t.width = c(e2.width), t.color = e2.color, t;
    });
    return (t, x2) => (openBlock(), createElementBlock("svg", {
...
var b35 = defineComponent({
  ...
  setup(n2, { emit: s }) {
    const e2 = n2, c = (t) => {
      ...
      const t = {};
      return t.height = l(e2.height), t.width = l(e2.width), t.color = e2.color, t;
    });
    return (t, w27) => (openBlock(), createElementBlock("svg", {
      class: normalizeClass(unref(i2)),
      style: normalizeStyle(unref(a2)),
...
import "D:/VisualSC/Vue/123/vue-vite-temp-init/node_modules/@nutui/icons-vue/dist/style_icon.css";
...
//# sourceMappingURL=chunk-KRK6JTUN.js.map
